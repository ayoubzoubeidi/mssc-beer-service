...
import com.maz.msscbeerservice.config.OpenFeignConfig;
...
@FeignClient(name = "inventory-service", fallback = InventoryServiceFeignClientFailOver.class, configuration = OpenFeignConfig.class)
